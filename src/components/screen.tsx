...
function ScreenWithoutScrolling(props: ScreenProps) {
  ...
  const outerClassName = twMerge('flex-1 h-full w-full', className);
  ...
  return (
    <View style={style} className={outerClassName}>
      <View style={contentContainerStyle} className={innerClassName}>
        {children}
      </View>
    </View>
  );
...
function ScreenWithScrolling(props: ScreenProps) {
  ...
  return (
    <View className={outerClassName} style={style}>
 ...
 * Now supports Tailwind CSS classes through the `className` and `contentContainerClassName` props.
...
export function Screen(props: ScreenProps) {
  ...
  const containerClassName = twMerge(
    'flex-1 h-full w-full bg-white dark:bg-neutral-900',
    className
  );
